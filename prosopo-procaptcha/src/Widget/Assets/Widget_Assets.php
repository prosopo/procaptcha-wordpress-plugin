...
class Widget_Assets {
	 ...
	 */
	public function enqueue_widget_js( string $handle, Plugin_Assets_Manager $assets_manager, array $general_settings ): void {
	 ...
	 */
	public function enqueue_integration_js_files( string $handle_prefix, Plugin_Assets_Manager $assets_manager, array $integration_names ): void {
		array_map(
