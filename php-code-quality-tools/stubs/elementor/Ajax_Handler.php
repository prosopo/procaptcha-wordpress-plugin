...
class Ajax_Handler {
	...
	public function __construct() {
		add_action( 'wp_ajax_elementor_pro_forms_send_form', array( $this, 'ajax_send_form' ) );
		add_action( 'wp_ajax_nopriv_elementor_pro_forms_send_form', array( $this, 'ajax_send_form' ) );
	}
	...
	public function ajax_send_form() {
		...
		if ( empty( $form ) ) {
			$this
				->add_error_message( self::get_default_message( self::INVALID_FORM, array() ) )
				->send();
		}
