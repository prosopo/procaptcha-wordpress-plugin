...
final class FLBuilderModel {
	 ...
	 */
	public static $settings_forms = array();
	 ...
	 */
	public static $settings_form_defaults = array();
	 ...
	 */
	public static $module_aliases = array();
	 ...
	 */
	private static $last_generated_node_id = null;
	 ...
	 */
	private static $published_layout_data = array();
	 ...
	 */
	private static $draft_layout_data = array();
	 ...
	 */
	private static $template_data = null;
	 ...
	 */
	private static $node_template_post_ids = array();
	 ...
	 */
	private static $node_template_types = array();

	private static $get_user_templates_cache = array();
	 ...
	 * @return string
	 */
	public static function get_edit_url( $post_id = false, $include_ui = true ) {
		if ( false === $post_id ) {
			global $post;
		} else {
	 ...
	 * @return string
	 */
	public static function get_relative_plugin_url() {
	 ...
	 * @return void
	 */
	public static function update_post_data( $key, $value ) {
	 ...
	 * @return array
	 */
	public static function get_global_posts() {
		/**
	 ...
	 */
	public static function get_post_id( $force_globals = false ) {
	 ...
	 * @return object
	 */
	public static function filter_global_settings( $new_settings ) {
		// row margin.
	 ...
	 * @return void
	 */
	public static function lock_post( $response, $data ) {
	 ...
	 * @return bool
	 */
	public static function is_builder_enabled( $post_id = null ) {
		global $wp_the_query;
	 ...
	 * @return bool
	 */
	public static function is_builder_draft_preview() {
	 ...
	 * @return string
	 */
	public static function get_node_status() {
	 ...
	 * @return array
	 */
	public static function get_cache_dir( $name = 'cache' ) {
	 ...
	 * @return string
	 */
	public static function get_asset_version( $path = false ) {
	 ...
	 * @return string
	 */
	public static function get_asset_enqueue_method() {
		/**
	 ...
	 * @return void
	 */
	public static function delete_asset_cache( $type = false ) {

		if ( 'inline' === self::get_asset_enqueue_method() ) {
			return false;
		}
	 ...
	 * @return void
	 */
	public static function delete_all_asset_cache( $post_id = false ) {
		$post_id   = $post_id ? $post_id : self::get_post_id();
		$cache_dir = self::get_cache_dir();

		if ( $post_id && 'file' === self::get_asset_enqueue_method() ) {
	 ...
	 * @return void
	 */
	public static function delete_node_template_asset_cache( $post_id = false ) {
	 ...
	 * @return void
	 */
	public static function delete_asset_cache_for_all_posts( $parts = '*' ) {
		$cache_dir = self::get_cache_dir();
	 ...
	 * @return array
	 */
	public static function generate_new_node_ids( $data ) {
		$map   = array();
		$nodes = array();
	 ...
	 * @return object
	 */
	public static function get_node( $node_id = null, $status = null ) {
	 ...
	 * @return array
	 */
	public static function get_nodes( $type = null, $parent_id = null, $status = null ) {
	 ...
	 * @return object
	 */
	public static function get_node_parent( $node_id = null, $status = null ) {
		$parent = null;
	 ...
	 */
	public static function get_node_parent_by_type( $node, $type = '' ) {
	 ...
	 * @return array
	 */
	public static function get_child_nodes( $parent_id, $status = null ) {
		$parent           = is_object( $parent_id ) ? $parent_id : self::get_node( $parent_id );
	 ...
	 * @return array
	 */
	public static function get_nested_nodes( $parent_id ) {
	 ...
	 * @return array
	 */
	public static function get_categorized_nodes() {
	 ...
	 * @return array
	 */
	public static function get_categorized_child_nodes( $parent = null ) {
		$categorized = array(
			'columns' => array(),
			'groups'  => array(),
			'modules' => array(),
	 ...
	 * @return object
	 */
	public static function get_node_settings( $node, $filter = true ) {
	 ...
	 * @return object
	 */
	public static function get_node_settings_with_defaults_merged( $type, $settings ) {
		$defaults = array();
		...
		if ( 'row' == $type ) {
			...
			$defaults = self::get_module_defaults( $settings->type );
		}
		...
		if ( 'row' == $type ) {
			...
			$settings = self::merge_nested_module_defaults( $settings->type, $settings );
		}
	 ...
	 * @return object
	 */
	public static function process_node_settings( $node, $new_settings ) {
	 ...
	 * @return object
	 */
	public static function get_node_defaults( $node ) {
		$defaults = array();
	 ...
	 * @return object
	 */
	public static function get_node_spacing_breakpoint_placeholders( $type, $property, $size ) {
	 ...
	 * @return int
	 */
	public static function order_nodes( $a, $b ) {
	 ...
	 * @return int
	 */
	public static function count_nodes( $type = 'row', $parent_id = null ) {
	 ...
	 * @return int
	 */
	public static function next_node_position( $type = 'row', $parent_id = null ) {
	 ...
	 * @return void
	 */
	public static function delete_node( $node_id = null ) {
		// Get the layout data.
	 ...
	 * @return void
	 */
	public static function delete_child_nodes_from_data( $parent, &$data ) {
	 ...
	 * @return void
	 */
	public static function call_module_delete( $node ) {
	 ...
	 * @return void
	 */
	public static function reorder_node( $node_id = null, $position = 0 ) {
		$data    = self::get_layout_data();
		$node    = $data[ $node_id ];
	 ...
	 * @return void
	 */
	public static function move_node( $node_id = null, $new_parent_id = null, $position = 0 ) {
		$data        = self::get_layout_data();
	 ...
	 */
	public static function add_row( $cols = '1-col', $position = false, $module = null ) {
		$data        = self::get_layout_data();
	 ...
	 * @return void
	 */
	public static function copy_row( $node_id = null, $settings = null, $settings_id = null ) {
	 ...
	 * @return object
	 */
	public static function get_row_defaults() {
	 ...
	 * @return object
	 */
	public static function get_row_bg_data( $row ) {
		$data = null;
	 ...
	 * @return string
	 */
	public static function get_row_slideshow_source( $row ) {
		// Make sure we have a photo data object.
		if ( ! isset( $row->settings->ss_photo_data ) ) {
			$row->settings->ss_photo_data = new StdClass();
		}
	 ...
	 * @return void
	 */
	public static function resize_row_content( $node_id, $width ) {
		$data                             = self::get_layout_data();
		$row                              = self::get_node( $node_id );
	 ...
	 */
	public static function add_col_group( $node_id = null, $cols = '1-col', $position = false, $module = null ) {
		$data          = self::get_layout_data();
	 ...
	 * @return object
	 */
	public static function process_col_settings( $col, $new_settings ) {
		$post_data = self::get_post_data();
	 ...
	 * @return void
	 */
	public static function delete_col( $node_id = null, $new_width = 100 ) {
	 ...
	 * @return void
	 */
	public static function reorder_col( $node_id, $position = 0 ) {
		$col = self::get_node( $node_id );
	 ...
	 * @return void
	 */
	public static function move_col( $col_id, $group_id, $position, $resize = array() ) {
	 ...
	 */
	public static function resize_col( $node_id = null, $new_width = 100 ) {
		$data           = self::get_layout_data();
		$col            = $data[ $node_id ];
	 ...
	 */
	public static function resize_cols( $col_id = null, $col_width = null, $sibling_id = null, $sibling_width = null ) {
		$data = self::get_layout_data();
	 ...
	 * @return void
	 */
	public static function reset_col_widths( $group_id = null ) {
	 ...
	 */
	public static function add_col( $node_id = null, $position = false ) {
	 ...
	 * @return object
	 */
	public static function add_cols( $col_id, $insert = 'before', $type = '1-col', $nested = false, $module = null ) {
		$data         = self::get_layout_data();
		$col          = self::get_node( $col_id );
	 ...
	 */
	public static function add_col_parent( $parent_id = null, $position = null ) {
		$data   = self::get_layout_data();
	 ...
	 * @return object The parent node.
	 */
	public static function get_col_parent( $type, $column_id ) {
	 ...
	 * @return void
	 */
	public static function copy_col( $node_id = null, $settings = null, $settings_id = null ) {
		$layout_data = self::get_layout_data();
		$col         = self::get_node( $node_id );
		$new_col_id  = self::generate_node_id();
		$nodes       = self::get_nodes( null, $col );
	 ...
	 * @return object
	 */
	public static function get_col_defaults() {
	 ...
	 */
	public static function filter_module( $module ) {
	 ...
	 * @return void
	 */
	public static function register_module_alias( $alias, $config ) {
		...
		$instance->template = isset( $config['template'] ) ? $config['template'] : array();
	 ...
	 * @return object|null
	 */
	public static function get_module_alias( $alias ) {
		if ( isset( self::$module_aliases[ $alias ] ) ) {
	 ...
	 * @return array|null
	 */
	public static function get_module_alias_settings( $alias ) {
		if ( isset( self::$module_aliases[ $alias ] ) ) {
	 ...
	 * @return void
	 */
	public static function is_module_registered( $type ) {
	 ...
	 * @return array
	 */
	public static function get_default_enabled_modules() {
	...
	public static function get_module_groups() {
		$groups    = array();
		$templates = self::get_module_templates_data();
	 ...
	 * @return array
	 */
	public static function get_module_categories() {
		$categories = array();
	 ...
	 * @return array
	 */
	public static function get_categorized_modules( $show_disabled = false ) {
		$enabled_modules = self::get_enabled_modules();
		$widgets         = null;
	 ...
	 * @return array
	 */
	public static function get_uncategorized_modules( $show_disabled = false ) {
		$enabled_modules = self::get_enabled_modules();
		$modules         = array();
	 ...
	 */
	public static function get_module( $node_id ) {
	 ...
	 * @return array
	 */
	public static function get_modules( $col_id = null ) {
	 ...
	 */
	public static function add_module( $type = null, $settings = array(), $parent_id = null, $position = false ) {
		$data           = self::get_layout_data();
	 ...
	 * @return string|null The new parent ID or null if none exists.
	 */
	public static function add_module_parent( $module, $parent_id = null, $position = null ) {
		$parent = ! $parent_id ? null : self::get_node( $parent_id );
	 ...
	 * @return object The parent node.
	 */
	public static function get_module_parent( $type, $module_id ) {
	 ...
	 */
	public static function add_default_module( $parent_id = null, $type = null, $position = null, $defaults = null, $template = null ) {
	 ...
	 * @return void
	 */
	public static function add_default_module_template( $module_id, $template ) {
		$position = 0;
	 ...
	 * @return object The new module object.
	 */
	public static function copy_module( $node_id = null, $settings = null, $parent_id = null, $position = null ) {
	 ...
	 * @return object
	 */
	public static function process_module_settings( $module, $new_settings ) {
	 ...
	 * @return object
	 */
	public static function clone_module_settings( $settings ) {
	 ...
	 * @return object|array
	 */
	public static function get_module_defaults( $type = null ) {
	 ...
	 * @return object
	 */
	public static function merge_nested_module_defaults( $type, $settings ) {
	 ...
	 * @return array
	 */
	public static function get_wp_sidebars() {
	 ...
	 * @return array
	 */
	public static function get_column_groups() {
		$cols = array(
			array(
				'count' => 1,
				'id'    => '1-col',
	 ...
	 * @return void
	 */
	public static function register_settings_form( $id, $form ) {
		/**
		 * Use this filter to modify the config array for a settings form when it is registered.
		 *
	 ...
	 * @return array
	 */
	public static function get_settings_form( $id ) {
	 ...
	 * @return array
	 */
	public static function get_settings_form_fields( $form, $group = null ) {
		$fields = array();

		if ( 'string' === gettype( $form ) ) {
			if ( 'general' === $group ) {
				$form = self::$settings_forms[ $form ]['tabs'];
			} elseif ( 'module' === $group ) {
				$form = self::$modules[ $form ]->form;
			} else {
				return $fields;
			}
		}
	 ...
	 * @return object
	 */
	public static function get_settings_form_defaults( $type ) {
	 ...
	 * @return object
	 */
	public static function merge_nested_form_defaults( $type, $form, $settings ) {
	...
	public static function save_settings( $node_id = null, $settings = null ) {
		$node = self::get_node( $node_id );
		if ( ! self::user_has_unfiltered_html() && true !== self::verify_settings( $settings ) ) {
			return array(
		 ...
		 */
		if ( ! self::user_has_unfiltered_html() ) {
	 ...
	 * @since 2.4.2
	 */
	public static function fix_kses( $value ) {
	 ...
	 * @return object
	 */
	public static function sanitize_settings( $settings, $form, $group ) {
		$fields = self::get_settings_form_fields( $form, $group );
		...
		foreach ( $settings as $name => $value ) {
			...
			if ( isset( $fields[ $name ]['sanitize'] ) ) {
				...
				$allowed = apply_filters(
					'fl_builder_node_container_element_options',
					array(
						'article' => '&lt;article&gt;',
						'aside'   => '&lt;aside&gt;',
						'div'     => '&lt;div&gt;',
	 ...
	 */
	public static function slash_settings( $data ) {
		if ( is_array( $data ) ) {
			foreach ( $data as $key => $val ) {
	 ...
	 * @return void
	 */
	public static function default_settings( &$settings, $defaults ) {
	 ...
	 * @return object
	 */
	public static function save_global_settings( $settings = array() ) {
	 ...
	 */
	public static function duplicate_post( $post_id = false ) {
		global $wpdb;
	 ...
	 * @return void
	 */
	public static function save_revision( $post_id, $post, $update ) {
	 ...
	 * @since 2.1.5
	 */
	public static function save_layout_revision( $post_id ) {
	 ...
	 * @since 2.1.5
	 */
	public static function save_layout_revision_changed_filter( $post_has_changed, $last_revision, $post ) {
	 ...
	 * @return array
	 */
	public static function get_layout_data( $status = null, $post_id = null ) {
		$post_id = ! $post_id ? self::get_post_id() : $post_id;
	 ...
	 * @return void
	 */
	public static function delete_layout_data( $status = null, $post_id = null ) {
	 ...
	 * @return array
	 */
	public static function clean_layout_data( $data = array() ) {
		$cleaned = array();
	 ...
	 * @return array
	 */
	public static function array_remove_by_values( $haystack, $values, $whitelist = array( 'animation', 'style', 'post_columns', 0, 1, 3, 4, 5 ) ) {
	 ...
	 * @return bool
	 */
	public static function layout_has_drafted_changes() {
		$post_id   = self::get_post_id();
	 ...
	 * @return object
	 */
	public static function get_layout_settings( $status = null, $post_id = null ) {
		$status   = ! $status ? self::get_node_status() : $status;
		$post_id  = ! $post_id ? self::get_post_id() : $post_id;
	 ...
	 * @return object
	 */
	public static function update_layout_settings( $settings = array(), $status = null, $post_id = null ) {
		$status       = ! $status ? self::get_node_status() : $status;
		$post_id      = ! $post_id ? self::get_post_id() : $post_id;
		$key          = 'published' == $status ? '_fl_builder_data_settings' : '_fl_builder_draft_settings';
	 ...
	 * @return object
	 */
	public static function save_layout_settings( $settings = array(), $status = null, $post_id = null ) {
	 ...
	 * @return void
	 */
	public static function delete_layout_settings( $status = null, $post_id = null ) {
		$status  = ! $status ? self::get_node_status() : $status;
		$post_id = ! $post_id ? self::get_post_id() : $post_id;
		$key     = 'published' == $status ? '_fl_builder_data_settings' : '_fl_builder_draft_settings';
	 ...
	 * @return object
	 */
	public static function merge_layout_settings( $settings, $merge_settings ) {
		$keys = array( 'css', 'js' );
	 ...
	 * @return void
	 */
	public static function clear_draft_layout() {
		$post_id  = self::get_post_id();
	...
	public static function cleanup_post_data( $post_id, $history = true ) {
	 ...
	 * @return array
	 */
	public static function duplicate_wpml_layout( $original_post_id = null, $new_post_id = null ) {
		$post_data        = self::get_post_data();
	 ...
	 * @return bool
	 */
	public static function is_post_user_template( $type = null ) {
		$post = self::get_post();
	 ...
	 * @return bool
	 */
	public static function is_post_container_module_template() {
	 ...
	 * @return bool
	 */
	public static function is_post_leaf_module_template() {
	 ...
	 * @return void
	 */
	public static function save_user_template( $settings = array() ) {
	 ...
	 * @return array
	 */
	public static function get_user_templates( $type = 'layout' ) {
		...
		foreach ( $posts as $post ) {
			...
			$templates[] = array(
				'category' => array(),
				'content'  => self::get_user_template_type( $post ),
				'id'       => get_post_meta( $post, '_fl_builder_template_id', true ),
				'image'    => $image,
				'isGlobal' => self::is_post_global_node_template( $post ),
				'kind'     => 'template',
	 ...
	 * @return string
	 */
	public static function get_user_template_type( $template_id = null ) {
		if ( $template_id && isset( self::$node_template_types[ $template_id ] ) ) {
			return self::$node_template_types[ $template_id ];
		}

		$post = $template_id ? get_post( $template_id ) : self::get_post();
	 ...
	 * @return void
	 */
	public static function delete_user_template( $template_id = null ) {
	 ...
	 * @return array
	 */
	public static function apply_user_template( $template = null, $append = false ) {
	 ...
	 * @return bool
	 */
	public static function node_templates_enabled() {
	 ...
	 * @return bool
	 */
	public static function is_post_node_template( $post_id = false, $type = null ) {
		$post_id = $post_id ? $post_id : self::get_post_id();
		$post    = get_post( $post_id );
	 ...
	 * @return bool
	 */
	public static function is_post_global_node_template( $post_id = false ) {
		$post_id = $post_id ? $post_id : self::get_post_id();
	 ...
	 * @return bool|int
	 */
	public static function is_node_global( $node ) {
	 ...
	 * @return bool
	 */
	public static function is_node_visible( $node ) {
		global $wp_the_query;
	 ...
	 * @return bool
	 */
	public static function node_has_visibility_rules( $node ) {
		$rules = false;
		if ( isset( $node->settings->visibility_display ) && ( '' !== $node->settings->visibility_display ) ) {
			$rules = true;
		}
	 ...
	 * @return bool
	 */
	public static function node_visibility_rules( $node ) {
	 ...
	 * @return bool|int
	 */
	public static function is_node_template_root( $node ) {
	 ...
	 * @return array
	 */
	public static function get_node_templates( $type = '' ) {
		$posts = get_posts(
			array(
				'order'          => 'ASC',
				'orderby'        => 'title',
	 ...
	 * @return object
	 */
	public static function get_node_template_root( $type = '', $nodes = array() ) {
		if ( '' != $type ) {
	 ...
	 * @return int
	 */
	public static function get_node_template_post_id( $template_id ) {
	 ...
	 * @return string
	 */
	public static function get_node_template_edit_url( $template_id ) {
	 ...
	 * @return array
	 */
	public static function get_posts_with_global_node_template( $post_id = false ) {
		$posts = array();
	 ...
	 * @return void
	 */
	public static function set_node_template_default_type( $post_id, $post, $update ) {
		global $pagenow;
	 ...
	 * @return void
	 */
	public static function delete_node_template( $template_id ) {
	 ...
	 * @return void
	 */
	public static function unlink_global_node_template_from_all_posts( $template_post_id ) {
	 ...
	 * @return void
	 */
	public static function unlink_global_node_template_from_post( $status, $post_id, $template_post_id, $template_id ) {
	 ...
	 * @return void
	 */
	public static function delete_global_node_template_from_all_posts( $template_post_id ) {
		if ( self::is_post_global_node_template( $template_post_id ) ) {
	 ...
	 * @return void
	 */
	public static function delete_global_node_template_from_post( $status, $post_id, $template_id ) {
		$layout_data = self::get_layout_data( $status, $post_id );
		$update      = false;
	...
	public static function apply_node_template( $template_id = null, $parent_id = null, $position = 0, $template = null ) {
		...
		$override = apply_filters(
			'fl_builder_override_apply_node_template',
			false,
			array(
				'parent_id'        => $parent_id,
				'position'         => $position,
	 ...
	 * @return void
	 */
	public static function register_templates( $path = false, $args = array() ) {
	 ...
	 * @return void
	 */
	public static function apply_template( $index = 0, $append = false, $type = 'layout' ) {
		/**
		 ...
		 */
		$override = apply_filters(
			'fl_builder_override_apply_template',
			false,
			array(
				'append' => $append,
				'index'  => $index,
	 ...
	 * @return array
	 */
	public static function apply_core_template( $index = 0, $append = false, $type = 'layout' ) {
	 ...
	 * @return object
	 */
	public static function get_template( $index, $type = 'layout' ) {
	 ...
	 * @return array
	 */
	public static function get_templates( $type = 'layout', $cached = true ) {
	 ...
	 * @return bool
	 */
	public static function has_templates() {
	 ...
	 * @return array
	 */
	public static function get_template_selector_data( $type = 'layout' ) {
		...
		foreach ( self::get_templates( $type ) as $key => $template ) {
			...
			$templates[] = apply_filters(
				...
				array(
					...
					'kind'     => 'template',
					'name'     => $template->name,
					'premium'  => isset( $template->premium ) ? (bool) $template->premium : false,
					'subtype'  => $type,
					'tags'     => array(),
					'type'     => 'core',
				),
		...
		return apply_filters(
			'fl_builder_template_selector_data',
			array(
				'categorized' => $categorized,
				'groups'      => $groups,
				'templates'   => $templates,
	 ...
	 * @return array
	 */
	public static function get_row_templates_data() {
	 ...
	 * @return array
	 */
	public static function get_column_templates_data() {
	 ...
	 * @return array
	 */
	public static function get_module_templates_data() {
	 ...
	 * @return object
	 */
	public static function get_pro_modules_config() {
	 ...
	 * @return object
	 */
	public static function save_color_presets( $presets = array() ) {
	 ...
	 * @return bool
	 */
	public static function is_inline_enabled() {
	 ...
	 * @return bool
	 */
	public static function is_codechecking_enabled() {
	 ...
	 * @return array
	 */
	public static function ace_editor_settings() {
	 ...
	 * @return bool
	 */
	public static function current_user_has_capability( $cap ) {
		if ( strstr( $cap, ',' ) ) {
	 ...
	 * @return array
	 */
	public static function get_help_button_defaults() {
		$defaults = array(
			'enabled'            => true,
			'forums'             => true,
			'forums_url'         => self::get_store_url(
				'knowledge-base',
				array(
			...
			'knowledge_base'     => true,
			'knowledge_base_url' => self::get_store_url(
				'knowledge-base',
				array(
	 ...
	 * @return array
	 */
	public static function get_row_resize_settings() {
		$defaults = array(
	 ...
	 * @return array
	 */
	public static function filter_row_settings_for_resize( $form, $id ) {

		if ( 'row' == $id && ! self::user_can_resize_rows() ) {
	 ...
	 * @return bool
	 */
	public static function user_can_resize_rows() {
	 ...
	 * @return void
	 */
	public static function delete_service_account( $service, $account ) {
		$services = self::get_services();
	 ...
	 * @return mixed
	 */
	public static function update_admin_settings_option( $key, $value, $network_override = true, $autoload = false ) {
		if ( is_network_admin() ) {
	 ...
	 * @since 2.5
	 */
	public static function uniqid( $prefix = '', $length = 12 ) {
	 ...
	 * @since 2.6
	 */
	public static function user_has_unfiltered_html() {
	 ...
	 * @deprecated 1.8
	 */
	public static function save_templates( $templates = array() ) {
	 ...
	 * @deprecated 1.8
	 */
	public static function save_template( $settings ) {
	 ...
	 * @deprecated 1.8
	 */
	public static function update_template( $old_index, $settings ) {
	 ...
	 * @deprecated 1.8
	 */
	public static function delete_template( $index ) {
	 ...
	 * @deprecated 1.10
	 */
	public static function get_editing_capability() {
	 ...
	 * @deprecated 1.10
	 */
	public static function current_user_has_editing_capability() {
	 ...
	 * @deprecated 1.10
	 */
	public static function get_global_templates_editing_capability() {
		_deprecated_function( __METHOD__, '1.10', 'FLBuilderUserAccess::current_user_can' );
	 ...
	 * @deprecated 1.10
	 */
	public static function user_templates_admin_enabled() {
	 ...
	 * @deprecated 2.0
	 */
	public static function get_module_category_slug( $name ) {
	 ...
	 * @deprecated 2.0
	 */
	public static function get_template_selector_filter_data() {
		_deprecated_function( __METHOD__, '2.0' );
	 ...
	 * @return void
	 */
	private static function register_core_templates() {
