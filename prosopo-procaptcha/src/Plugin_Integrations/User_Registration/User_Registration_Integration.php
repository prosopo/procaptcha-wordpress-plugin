...
final class User_Registration_Integration extends Plugin_Integration_Base {
	...
	protected function get_hookable_integrations(): array {
		...
		$is_on_wp_login_form     = bool( $settings, Account_Forms_Tab::IS_ON_WP_LOGIN_FORM );
		$is_on_wp_lost_pass_form = bool( $settings, Account_Forms_Tab::IS_ON_WP_LOST_PASSWORD_FORM );
