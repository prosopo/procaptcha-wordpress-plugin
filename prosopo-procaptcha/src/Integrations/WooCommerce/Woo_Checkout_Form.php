...
class Woo_Checkout_Form extends Hookable_Form_Integration {
	...
	public function print_blocks_checkout_field( string $content, array $block ): string {
		...
		if ( 'woocommerce/checkout-additional-information-block' === $block_name ) {
			...
			$suffix  = self::get_form_helper()->get_captcha()->print_form_field(
				array(
		...
		if ( function_exists( 'woocommerce_register_additional_checkout_field' ) ) {
			woocommerce_register_additional_checkout_field(
				array(
					...
					'label'                      => self::get_form_helper()->get_captcha()->get_field_name(),
					'location'                   => 'order',
					'required'                   => true,
